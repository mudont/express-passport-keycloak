...
passport.use(new KeyCloakStrategy({
    ...
    callbackURL: process.env["KEYCLOAK_AUTH_CALLBACK_URL"],
}, function (accessToken, refreshToken, tokens, profile, done) {
...
router.get("/login", passport.authenticate(auth_strategy, { scope: ["openid", "profile"] }));
router.get("/oauth2/redirect", passport.authenticate(auth_strategy, {
    successRedirect: "/",
